...
def draw_paper_ready_plots(csv_dir, start=8, end=201, step=12):
    # =========================
    # 1. 自动读取目录下所有 csv 并合并
    # =========================
...
if __name__ == "__main__":
    CSV_DIRECTORY = "/root/work/coupon/coup_spread/gzc-impl/results/network.netscience/paper-netscience-h-1.0/" 
