...
# gzc-impl/results/network.netscience/paper-netscience-h-2.0
# python mock_celf_data.py --data network.EmailEnron --version 2026-3-22 --start 100 --end 401 --step 100
# python mock_celf_data.py --data network.netscience --version paper-netscience-h-2.0 --start 8 --end 201 --step 12
