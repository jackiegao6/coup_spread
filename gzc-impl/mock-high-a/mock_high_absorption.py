...
DATASETS = [
    {"name": "netscience",     "nodes": 379,   "scale": 85.0},    
    {"name": "netfacebookego", "nodes": 2888,  "scale": 90.0},   
    {"name": "doubanrandom",   "nodes": 4723,  "scale": 95.0},   
    {"name": "EmailEnron",     "nodes": 33696, "scale": 95.0}
]
