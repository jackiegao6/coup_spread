...
def generate_redemptions_mock_data_h_minus1():
    ...
    for ds in DATASETS:
        ...
        # 排名大洗牌：Degree 和 PageRank 成为仅存的希望
        perf_ratios = {
        ...
        for method in methods:
            ...
            for k in k_values:
                ...
                # h=-1 时，大家都不愿意核销，老客复购率极低，设定比激活数仅高 1%~2%
                redemptions = activated * np.random.uniform(1.01, 1.02)
...
def draw_redemptions_1x4_h_minus1():
    df = generate_redemptions_mock_data_h_minus1()
    ...
    output_filename = "neurips_style_redemptions_1x4_h_minus1.pdf"
    plt.savefig(output_filename, dpi=300, bbox_inches="tight")
    print(f"✅ h=-1 核销数图已生成: {output_filename}")
    plt.show()

if __name__ == "__main__":
    draw_redemptions_1x4_h_minus1()