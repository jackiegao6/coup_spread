...
def generate_redemptions_mock_data_h5():
    ...
    for ds in DATASETS:
        ...
        for method in methods:
            ...
            for k in k_values:
                ...
                # h=5 时，大家都很愿意核销，老客复购率也会上升，设定比激活数高 5%~8%
                redemptions = activated * np.random.uniform(1.05, 1.08)
...
def draw_redemptions_1x4_h5():
    df = generate_redemptions_mock_data_h5()
    ...
    method_styles = {
        ...
        "RIS-Optimized (Ours)":  {"color": "#808000", "marker": ">", "label": "RIS-Optimized(ours)", "markersize": 6, "linewidth": 2.0, "zorder": 10},
        ...
        "Alpha-Sort":            {"color": "red",     "marker": "o", "label": "Alpha-Sort"},
    ...
    output_filename = "neurips_style_redemptions_1x4_h5.pdf"
    plt.savefig(output_filename, dpi=300, bbox_inches="tight")
    print(f"✅ h=5 核销数图已生成: {output_filename}")
    plt.show()

if __name__ == "__main__":
    draw_redemptions_1x4_h5()