...
if __name__ == "__main__":
    ...
    # 定义配置
    config_example = {
        'degree_exponent_succ': 0.5,  # 度数越高，越不倾向于“接受”
        'degree_exponent_dis': -1.0,  # 度数越高，略微不倾向于“抛弃”
        'degree_exponent_tran': 1.5,  # 度数越高，越倾向于“转发”
        'randomness_factor': 0.2  # 10%的随机扰动
    }
    ...
    # -----------------------------------------------------------------
    # 0 | 0 | 0.3012 | 0.3811 | 0.3177 | 1.00
    # 1 | 1 | 0.3010 | 0.0565 | 0.6425 | 1.00
    # 2 | 3 | 0.1762 | 0.0058 | 0.8181 | 1.00
    # 3 | 5 | 0.1311 | 0.0012 | 0.8677 | 1.00
    # 4 | 7 | 0.1338 | 0.0007 | 0.8656 | 1.00
    # 5 | 11 | 0.0613 | 0.0001 | 0.9386 | 1.00
    # 6 | 17 | 0.0384 | 0.0000 | 0.9615 | 1.00
    # -----------------------------------------------------------------
    # 3. 打印并验证结果
